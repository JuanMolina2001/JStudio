            ...
            <div class=" p-3 h-screen w-screen">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex justify-evenly w-[300px]">
                        <a href="/new-project" target="_blank" class="border-white border-solid border-[1px] p-3 flex justify-center items-center rounded-md w-[74px] h-[74px]">
                        ...
                        <button class="border-white border-solid border-[1px] p-3 rounded-md w-[74px] h-[74px]" onClick={() => {
                            window.JStudio.init({ create: false }, (project) => {
